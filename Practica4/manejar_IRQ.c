...
void configurar_IRQ()
{
	...
	// Configuramos EINT0, EINT1 y EINT2 para activarse en flanco de bajada.
	...
	// Asignamos prioridades IGUALES a cada interrupcion (no 0, reservado para timer)
	NVIC->IP[EINT0_IRQn] = 1 << 3;
	NVIC->IP[EINT1_IRQn] = 1 << 3;
